...
import wireproxy
from wireproxy.thirdparty.mitmproxy import connections
from wireproxy.thirdparty.mitmproxy.http import HTTPFlow
from wireproxy.thirdparty.mitmproxy.net.http import cookies
...
def generate_har(entries: List[dict]) -> str:
    ...
    har = {
        "log": {
            "version": "1.2",
            "creator": {
                "name": "Wire Proxy HAR dump",
                "version": wireproxy.__version__,
                "comment": f"Wire Proxy version {wireproxy.__version__}",
            },
            "entries": entries,
        }
    }
