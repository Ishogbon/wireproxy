...
from wireproxy.thirdparty.mitmproxy.net.http import cookies, status_codes, message
from wireproxy.thirdparty.mitmproxy.net.http.headers import Headers
from wireproxy.thirdparty.mitmproxy.utils import human, strutils
from wireproxy.thirdparty.mitmproxy.utils.strutils import always_bytes
...
class Response(message.Message):
    ...
    def cookies(self) -> multidict.MultiDictView:
        ...
        :py:class:`~wireproxy.thirdparty.mitmproxy.net.multidict.MultiDictView`,
