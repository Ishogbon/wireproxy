...
from wireproxy.thirdparty.mitmproxy.coretypes import bidi
from wireproxy.thirdparty.mitmproxy.net import tcp
from wireproxy.thirdparty.mitmproxy.utils import bits, human, strutils
...
OPCODE = bidi.BiDi(
    CONTINUE=0x00, TEXT=0x01, BINARY=0x02, CLOSE=0x08, PING=0x09, PONG=0x0A
)
