...
from wireproxy.thirdparty.mitmproxy.net import server_spec
from wireproxy.thirdparty.mitmproxy.net.http import status_codes
from wireproxy.thirdparty.mitmproxy.utils import human
import wireproxy.thirdparty.mitmproxy.types

CONF_DIR = os.path.join(tempfile.gettempdir(), ".wireproxy")
LISTEN_PORT = 8080
...
class Core:
    ...
    @command.argument(
        "attr", type=wireproxy.thirdparty.mitmproxy.types.Choice("flow.set.options")
    )
    def flow_set(
    ...
    @command.argument(
        "encoding",
        type=wireproxy.thirdparty.mitmproxy.types.Choice("flow.encode.options"),
    )
    def encode(
        self,
    ...
    def options_load(self, path: wireproxy.thirdparty.mitmproxy.types.Path) -> None:
        """
    ...
    def options_save(self, path: wireproxy.thirdparty.mitmproxy.types.Path) -> None:
        """
